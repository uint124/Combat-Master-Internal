...
namespace ImGui
{
    ...
    IMGUI_API bool          IsFontOnStack(ImFont* font);
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, const char* help_marker = nullptr);
    ...
    //   If you get a warning converting a float to ImGuiSliderFlags, read https://github.com/ocornut/imgui/issues/3361
    IMGUI_API bool          SliderFloat(const char* label, float* v, float v_min, float v_max, const char* format = "%.3f", float length = 100.f, ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
    ...
    IMGUI_API bool          SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, float length = 100.f, ImGuiSliderFlags flags = 0);
